...
for i in example_postgres_products_source.json example_postgres_customers_source.json example_snowflake_sink.json; do
    ...
    -e "s|<add_your_postgres_customers_hostname>|${POSTGRES_CUSTOMERS_ENDPOINT}|g" \
